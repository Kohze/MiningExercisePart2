    ...
    function (t, e, r) {
      ...
      (function (e) {
        ...
        (f.prototype.set = function (t) {
          ...
          (f.fromDER = f.fromBuffer = function (t, e) {
    ...
    function (t, e, r) {
      ...
      (function (e) {
        ...
        (c.prototype._classifyArgs = function (t, r) {
          ...
          (c.fromHex = c.fromString = function (t, r) {
          ...
          (c.prototype.toString = c.prototype.toHex = function () {
            return this.toDER().toString("hex");
          }),
    ...
    function (t, e, r) {
      ...
      (function (e) {
        ...
        (p.prototype._classifyArguments = function (t, r) {
          ...
          (p.fromObject = p.fromJSON = function (t) {
            return (
              d.checkArgument(
                n.isObject(t),
            ...
            if (R && x >= 0 && x <= s.OP_PUSHDATA4) {
              ...
              switch (x) {
                ...
                case s.OP_ELSE:
                  ...
                  this.vfExec[this.vfExec.length - 1] = !this.vfExec[
                    this.vfExec.length - 1
                  ];
                  break;
                case s.OP_ENDIF:
                  if (0 === this.vfExec.length)
    ...
    function (t, e, r) {
      ...
      (function (e) {
        ...
        Object.defineProperty(E.prototype, "inputAmount", O),
          ...
          (E.prototype.uncheckedSerialize = E.prototype.toString = function () {
            return this.toBuffer().toString("hex");
          }),
          ...
          (E.prototype.toObject = E.prototype.toJSON = function () {
            var t = [];
